...
urlpatterns = [
    ...
    path('Pending_Application', views.Pending_Application, name="Pending_Application"),
    path('MyApplication/<int:applicationId>', views.MyApplication, name="MyApplication")
